...
#PAWLS-START BY SLTS
outA0_50_LTS=simulate(L,n,beta,"A",method="PAWLS",initial="uniform-LTS",seed=NULL,useDataFile=TRUE)
outB0_50_LTS=simulate(L,n,beta,"B",method="PAWLS",initial="uniform-LTS",seed=NULL,useDataFile=TRUE)
outC0_50_LTS=simulate(L,n,beta,"C",method="PAWLS",initial="uniform-LTS",seed=NULL,useDataFile=TRUE)
outD20_50_LTS=simulate(L,n,beta,"D2",method="PAWLS",initial="uniform-LTS",seed=NULL,useDataFile=TRUE)

#PAWLS
confirm=simulate(L,n,beta,"A",method="PAWLS",initial="uniform",seed=NULL,useDataFile=TRUE)
outA0_50=simulate(L,n,beta,"A",method="PAWLS",initial="uniform",seed=NULL,useDataFile=TRUE)
outB0_50=simulate(L,n,beta,"B",method="PAWLS",initial="uniform",seed=NULL,useDataFile=TRUE)
outC0_50=simulate(L,n,beta,"C",method="PAWLS",initial="uniform",seed=NULL,useDataFile=TRUE)
outD20_50=simulate(L,n,beta,"D2",method="PAWLS",initial="uniform",seed=NULL,useDataFile=TRUE)
#APAWLS
outD2_50_2=simulate(L,n,beta,"D2",method="PAWLS",initial="PAWLS",seed=NULL,useDataFile=TRUE,updateInitial=TRUE)
outA_50=simulate(L,n,beta,"A",method="PAWLS",initial="PAWLS",seed=NULL,useDataFile=TRUE,updateInitial=TRUE)
outB_50=simulate(L,n,beta,"B",method="PAWLS",initial="PAWLS",seed=NULL,useDataFile=TRUE,updateInitial=TRUE)
outC_50=simulate(L,n,beta,"C",method="PAWLS",initial="PAWLS",seed=NULL,useDataFile=TRUE,updateInitial=TRUE)
outD2_50=simulate(L,n,beta,"D2",method="PAWLS",initial="PAWLS",seed=NULL,useDataFile=TRUE,updateInitial=TRUE)
#ROSS
...
#ADL
confirm2_ADL50=simulate(L,n,beta,"A",method="ADL",useDataFile=TRUE)
...
#PAWLS
outA0_500=simulate(L,n,beta,"A",method="PAWLS",seed=2015)
outC0_500=simulate(L,n,beta,"C",method="PAWLS",seed=2015)
outB0_500=simulate(L,n,beta,"B",method="PAWLS",seed=2015)
outD20_500=simulate(L,n,beta,"D2",method="PAWLS",seed=2015)


#PAWLS
outA0_500=simulate(L,n,beta,"A",method="PAWLS",initial="uniform",seed=2015)
outC0_500=simulate(L,n,beta,"C",method="PAWLS",initial="uniform",seed=2015)
outB0_500=simulate(L,n,beta,"B",method="PAWLS",initial="uniform",seed=2015)
outD20_500=simulate(L,n,beta,"D2",method="PAWLS",initial="uniform",seed=2015)

#APAWLS
outA0_500=simulate(L,n,beta,"A",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)
outC0_500=simulate(L,n,beta,"C",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)
outB0_500=simulate(L,n,beta,"B",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)
outD20_500=simulate(L,n,beta,"D2",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)

#ADL
outA_ADL500=simulate(L,n,beta,"A",method="ADL",seed=2015)
outC_ADL500=simulate(L,n,beta,"C",method="ADL",seed=2015)
outB_ADL500=simulate(L,n,beta,"B",method="ADL",seed=2015)
#outD_ADL500=simulate(L,n,beta,"D",method="ADL",seed=2015) 
outD2_ADL500=simulate(L,n,beta,"D2",method="ADL",seed=2015)
#LTS
...
#APAWLS
confrim=simulate(L,n,beta,"D2",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)
outA_500=simulate(L,n,beta,"A",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)
outC_500=simulate(L,n,beta,"C",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)
outB_500=simulate(L,n,beta,"B",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)
outD2_500=simulate(L,n,beta,"D2",method="PAWLS",initial="PAWLS",seed=2015,updateInitial=TRUE)
