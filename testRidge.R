...
outrc_502=simulate2(L,n,beta,"RC",initial="RRMM",method="RRREG",matlab=matlab,type="Ridge",seed=2017)
...
outrc_50s2=simulate2(L,n,beta,"RC",initial="S",method="RRREG",matlab=matlab,type="Ridge",seed=2017)
