...
outrA_50=simulate2(L,n,beta,"A",method="RRREG",matlab=matlab,useDataFile=FALSE,type="Ridge",seed=2016,
                   lambda1=seq(from=0.001,to=1,length.out=30),lambda2=seq(from=0.01,to=2,length.out=30))
outrc_50=simulate2(L,n,beta,"C",method="RRREG",matlab=maatlab,useDataFile=FALSE,type="Ridge",,seed=2016,
                   lambda1=seq(from=0.001,to=1,length.out=30),lambda2=seq(from=0.01,to=2,length.out=30))
